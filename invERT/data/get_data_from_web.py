...
def clean_extracted_files(dataset_folder: Path, events: str) -> None:
    """
    In the extracted directory, remove files that do not match the desired
    pattern. Here we keep only files ending with ".g12.gz".
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "4 (SHEAR-ZONE), 5 (DYKE), 6 (PLUG), 7 (TILT)"
        )
    )
    ...
    max_workers = min(8, len(events_lists))
